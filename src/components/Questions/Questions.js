...
const Questions = () => {
    ...
    return (
        <div className={`${dark ? "bg-light" : "bg-dark text-white"}`}>
            <div className="px-md-5 container py-4 mt-3">
                <Accordion className={`accordians ${dark ? "bg-light" : "bg-dark text-white"}`} defaultActiveKey="0">
                    <Accordion.Item className={`bg-light mb-4 ${dark ? "bg-light" : "bg-dark text-white"}`} eventKey="0">
                        <Accordion.Header className={` bg-dark ${dark ? "bg-light" : "bg-dark text-white"}`}>What is Pupils English Center?</Accordion.Header>
                        <Accordion.Body className={`accordians ${dark ? "bg-light" : "bg-dark text-white"}`}>
                    ...
                    <Accordion.Item className={`accordians mb-4 ${dark ? "bg-light" : "bg-dark text-white"}`} eventKey="1">
                        <Accordion.Header className={` ${dark ? "bg-light" : "bg-dark text-white"}`}>What is the purpose of these courses?</Accordion.Header>
                        <Accordion.Body className={` ${dark ? "bg-light" : "bg-dark text-white"}`}>
                    ...
                    <Accordion.Item className={` mb-4 ${dark ? "bg-light" : "bg-dark text-white"}`} eventKey="2">
                    ...
                    <Accordion.Item className={` ${dark ? "bg-light" : "bg-dark text-white"}`} eventKey="3">
