            ...
            <div>
                ...
                <h3 className='text-center font-bold text-xl mb-6'>Login Please</h3>
                    ...
                    <p className='text-center mb-4'>
                        <button className='bg-blue-800 text-center py-1   px-20 rounded text-white' type="submit">Login</button>
                    </p>

                    <small>Don't have an account? <Link to="/register" className='underline'>Register</Link> </small>
                </form>
            </div>
